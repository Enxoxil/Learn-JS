...
document.querySelector(".b-4").addEventListener("click", () => {
  max.call(document.querySelector(".out-4"), 22, 33);
});
...
let max1 = max.bind(document.querySelector(".out-12"), 11, 88);
max1();
// Task 13
...
let m2 = max.bind(document.querySelector(".out-13"), 50);
m2(499);
...
let t14 = t9.bind(document.querySelector(".out-14"), ...ar9);
console.log(t14());